    ...
    <div class="page-container">
        ...
        <div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex align-items-center gap-2 justify-content-between">
                            <span class="badge bg-info rounded-pill fs-13">5.7% <i class="ti ti-trending-down"></i>
                            </span>
                            <div class="text-end">
                ...
                <div class="card">
                    <div
                        ...
                        <div class="d-flex gap-2 justify-content-end text-end">
                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-light">Refresh <i class="ri-refresh-line ms-1"></i></a>
                        </div>
                    </div>
                    <div class="card-body pt-2">
                        <div dir="ltr">
                            <div id="data-visits-chart"
                                class="apex-charts"
                                data-colors="#5b69bc,#ff8acc,#10c469,#35b8e0"></div>
                        ...
                        <div class="border-top border-dashed mt-2">
                            <div class="row text-center align-items-center g-0">
                                <div class="col-md-4 col-12">
                                    ...
                                    <img src="/backend/assets/images/cards/american-express.svg"
                                        alt="user-card"
                                        height="36" />
                                    <img src="/backend/assets/images/cards/discover-card.svg"
                                        alt="user-card"
                                        height="36" />
                                    <img src="/backend/assets/images/cards/mastercard.svg"
                                        alt="user-card"
                                        height="36" />
                                </div>
                                <div class="col-md-4 col-6 border-start border-end border-dashed">
        ...
        <div class="row row-cols-xxl-5 row-cols-md-2 row-cols-1">
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="/backend/assets/images/users/avatar-7.jpg"
                            alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>John Smith</h5>
                            <p class="text-muted">Project Manager</p>
                            <p class="m-0 fs-14 text-truncate">80+ Feedbacks <a href="#!"
                                    class="link-reset fw-medium"><i class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="m-0 fs-14 text-truncate">90+ Feedbacks <a href="#!"
                                    class="link-reset fw-medium"><i class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        <img src="/backend/assets/images/users/avatar-5.jpg"
                            alt="team-member-image"
                            class="me-1 avatar-xl img-thumbnail rounded-circle">
                        <div>
                            <h5>Emily Brown</h5>
                            <p class="text-muted">Software Engineer</p>
                            <p class="m-0 fs-14 text-truncate">100+ Feedbacks <a href="#!"
                                    class="link-reset fw-medium"><i class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="m-0 fs-14 text-truncate">70+ Feedbacks <a href="#!"
                                    class="link-reset fw-medium"><i class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="m-0 fs-14 text-truncate">50+ Feedbacks <a href="#!"
                                    class="link-reset fw-medium"><i class="ti ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="d-flex card-header justify-content-between align-items-center">
                        ...
                        <a href="javascript:void(0);"
                            class="btn btn-sm btn-light">Add Brand <i class="ti ti-plus ms-1"></i></a>
                    </div>
                                ...
                                <tbody>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="/backend/assets/images/products/logo/logo-1.svg"
                                                            alt=""
                                                            height="22">
                                                    </span>
                                                </div>
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-info-subtle rounded-circle">
                                                        <img src="/backend/assets/images/products/logo/logo-2.svg"
                                                            alt=""
                                                            height="22">
                                                    </span>
                                                </div>
                                        ...
                                        <td>
                                            <span class="text-muted fs-12">Status</span>
                                            <h5 class="fs-14 mt-1 fw-normal"><i
                                                    class="ti ti-circle-filled fs-12 text-warning"></i>
                                                Pending
                                            </h5>
                                        </td>
                                        <td style="width: 30px;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="/backend/assets/images/products/logo/logo-3.svg"
                                                            alt=""
                                                            height="22">
                                                    </span>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                        <img src="/backend/assets/images/products/logo/logo-4.svg"
                                                            alt=""
                                                            height="22">
                                                    </span>
                                                </div>
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-danger-subtle rounded-circle">
                                                        <img src="/backend/assets/images/products/logo/logo-5.svg"
                                                            alt=""
                                                            height="22">
                                                    </span>
                                                </div>
                                        ...
                                        <td>
                                            <span class="text-muted fs-12">Status</span>
                                            <h5 class="fs-14 mt-1 fw-normal"><i
                                                    class="ti ti-circle-filled fs-12 text-danger"></i>
                                                Inactive
                                            </h5>
                                        </td>
                                        <td style="width: 30px;">
            ...
            <div class="col-xxl-6">
                <div class="card card-h-100">
                    <div class="card-header d-flex flex-wrap align-items-center gap-2 border-bottom border-dashed">
                        ...
                        <div class="d-flex gap-2 justify-content-end text-end">
                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-light">Import <i class="ti ti-download ms-1"></i></a>
                            <a href="javascript:void(0);"
                                class="btn btn-sm btn-primary">Export <i class="ti ti-file-export ms-1"></i></a>
                        </div>
                    </div>
                            ...
                            <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="/backend/assets/images/products/p-1.png"
                                                    alt="Product-10"
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="/backend/assets/images/products/p-2.png"
                                                    alt="Product-11"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="/backend/assets/images/products/p-3.png"
                                                    alt="Product-12"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="/backend/assets/images/products/p-4.png"
                                                    alt="Product-13"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 85px;">
                                            <div class="avatar-lg border rounded">
                                                <img src="/backend/assets/images/products/p-5.png"
                                                    alt="Product-14"
                                                    class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                            <h5 class="fs-14 my-1"><a href="#!"
                                                    class="link-reset">Classic Table
                                                    Lamp</a></h5>
