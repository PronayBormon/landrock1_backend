       ...
       <div class="sidenav-menu">
           ...
           <div data-simplebar>
               ...
               <ul class="side-nav">
                   ...
                   <li class="side-nav-item">
                       ...
                       <div class="collapse"
                           ...
                           <ul class="sub-menu">
                               <li class="side-nav-item">
                                   <a href="apps-user-contacts.html"
                                       class="side-nav-link">
                                       <span class="menu-text">Contacts</span>
                                   </a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="apps-user-profile.html"
                                       class="side-nav-link">
                   ...
                   <li class="side-nav-item">
                       ...
                       <div class="collapse"
                           ...
                           <ul class="sub-menu">
                               <li class="side-nav-item">
                                   <a href="apps-invoices.html"
                                       class="side-nav-link">
                                       <span class="menu-text">Invoices</span>
                                   </a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="apps-invoice-details.html"
                                       class="side-nav-link">
                                       <span class="menu-text">View Invoice</span>
                                   </a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="apps-invoice-create.html"
                                       class="side-nav-link">
                   ...
                   <li class="side-nav-item">
                       ...
                       <div class="collapse"
                           ...
                           <ul class="sub-menu">
                               ...
                               <li class="side-nav-item">
                                   <a href="error-service-unavailable.html"
                                       class="side-nav-link">
                   ...
                   <li class="side-nav-item">
                       ...
                       <div class="collapse"
                           ...
                           <ul class="sub-menu">
                               ...
                               <li class="side-nav-item">
                                   <a href="extended-sweetalerts.html"
                                       class="side-nav-link">
                   ...
                   <li class="side-nav-item">
                       ...
                       <div class="collapse"
                           ...
                           <ul class="sub-menu">
                               ...
                               <li class="side-nav-item">
                                   <a href="charts-apex-polar-area.html"
                                       class="side-nav-link">
                               ...
                               <li class="side-nav-item">
                                   <a href="charts-apex-slope.html"
                                       class="side-nav-link">
                                       <span class="menu-text">Slope</span>
                                   </a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="charts-apex-funnel.html"
                                       class="side-nav-link">
                   ...
                   <li class="side-nav-item">
                       ...
                       <div class="collapse"
                           ...
                           <ul class="sub-menu">
                               ...
                               <li class="side-nav-item">
                                   <a href="layouts-full.html"
                                       target="_blank"
                                       class="side-nav-link">Full View</a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="layouts-fullscreen.html"
                                       target="_blank"
                                       class="side-nav-link">Fullscreen
                                       View</a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="layouts-hover.html"
                                       target="_blank"
                                       class="side-nav-link">Hover Menu</a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="layouts-compact.html"
                                       target="_blank"
                                       class="side-nav-link">Compact</a>
                               </li>
                               <li class="side-nav-item">
                                   <a href="layouts-icon-view.html"
                                       target="_blank"
                                       class="side-nav-link">Icon View</a>
                               </li>
                           </ul>
                       </div>
                   </li>
               ...
               <!-- <div class="help-box text-center">
                    ...
                    <a href="javascript: void(0);"
                        class="btn btn-danger btn-sm">Upgrade</a>
                </div> -->
