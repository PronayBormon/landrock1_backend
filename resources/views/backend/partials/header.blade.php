            ...
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="/"
                        ...
                        <span class="logo-light">
                            <span class="logo-lg"><img src="/backend/assets/images/logo.png"
                                    alt="logo"></span>
                            <span class="logo-sm"><img src="/backend/assets/images/logo-sm.png"
                                    alt="small logo"></span>
                        </span>

                        <span class="logo-dark">
                            <span class="logo-lg"><img src="/backend/assets/images/logo-dark.png"
                                    alt="dark logo"></span>
                            <span class="logo-sm"><img src="/backend/assets/images/logo-sm.png"
                                    alt="small logo"></span>
                        </span>
                    ...
                    <div class="topbar-item d-none d-md-flex px-2">
                        ...
                        <div>
                            <h4 class="page-title fs-20 fw-semibold mb-0">@stack('title', 'Dashboard')</h4>
                        </div>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    {{-- <div class="topbar-search text-muted d-none d-xl-flex gap-2 me-2 align-items-center"
                        data-bs-toggle="modal"
                        data-bs-target="#searchModal"
                        type="button">
                            ...
                            <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg"
                                        ...
                                        <div class="col-auto">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <!-- item-->
                                                    <a href="javascript:void(0);"
                                                        class="dropdown-item">Mark as Read</a>
                                                    <!-- item-->
                                                    <a href="javascript:void(0);"
                                                        class="dropdown-item">Delete All</a>
                                                    <!-- item-->
                                                    <a href="javascript:void(0);"
                                                        class="dropdown-item">Do not
                                                        Disturb</a>
                                                    <!-- item-->
                                                    <a href="javascript:void(0);"
                                ...
                                <div class="position-relative rounded-0"
                                    ...
                                    <div class="dropdown-item notification-item py-2 text-wrap"
                                        ...
                                        <span class="d-flex align-items-center">
                                            <span class="me-3 position-relative flex-shrink-0">
                                                <img src="/backend/assets/images/users/avatar-10.jpg"
                                                    class="avatar-lg rounded-circle"
                                                    alt="" />
                                            </span>
                                            <span class="flex-grow-1 text-muted">
